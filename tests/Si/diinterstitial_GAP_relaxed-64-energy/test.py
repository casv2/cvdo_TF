...
<<<<<<< HEAD
    ...
    defect = relax_atoms_cell(defect, tol=fmax) ## NOT WRITING IN TO A FILE!
...
properties = {'diinterstitial_formation_energy_EXT':
                defect_energy(a0, e0, "model-GAP-6-test-diinterstitial-64-energy.txt.configs.split.0.xyz"), # "Si64_I2_EXT_1S_castep_relaxation_end.xyz") ,
'diinterstitial_formation_energy_TT':
                defect_energy(a0, e0, "model-GAP-6-test-diinterstitial-64-energy.txt.configs.split.1.xyz"), # "Si64_I2_TT_1NNN_castep_relaxation_end.xyz") ,
'diinterstitial_formation_energy_XEX':
                defect_energy(a0, e0, "model-GAP-6-test-diinterstitial-64-energy.txt.configs.split.2.xyz"), # "Si64_I2_XEX_0_castep_relaxation_end.xyz") ,
'diinterstitial_formation_energy_XT':
                defect_energy(a0, e0, "model-GAP-6-test-diinterstitial-64-energy.txt.configs.split.3.xyz"), # "Si64_I2_XT_01L_castep_relaxation_end.xyz") ,
'diinterstitial_formation_energy_W':
                defect_energy(a0, e0, "model-GAP-6-test-diinterstitial-64-energy.txt.configs.split.4.xyz"), # "Si64_I2_XT_02A_castep_relaxation_end.xyz") ,
'diinterstitial_formation_energy_XX3':
                defect_energy(a0, e0, "model-GAP-6-test-diinterstitial-64-energy.txt.configs.split.5.xyz") } # "Si64_I2_XX3_00A_castep_relaxation_end.xyz")}
